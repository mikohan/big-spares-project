	 ...
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z"
                ...
                <div class="product-card__image">
                  <a href="product-full.html">
                    <img
                      :src="
                        require('~/static/images/products/product-1-245x245.jpg')
                      "
                      alt=""
                    />
                  </a>
	 ...
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z"
                ...
                <div class="product-card__image">
                  <a href="product-full.html">
                    <img
                      :src="
                        require('~/static/images/products/product-2-245x245.jpg')
                      "
                      alt=""
                    />
                  </a>
	 ...
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z"
                ...
                <div class="product-card__image">
                  <a href="product-full.html">
                    <img
                      :src="
                        require('~/static/images/products/product-3-245x245.jpg')
                      "
                      alt=""
                    />
                  </a>
	 ...
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z"
                ...
                <div class="product-card__image">
                  <a href="product-full.html">
                    <img
                      :src="
                        require('~/static/images/products/product-4-245x245.jpg')
                      "
                      alt=""
                    />
                  </a>
	 ...
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z"
                ...
                <div class="product-card__image">
                  <a href="product-full.html">
                    <img
                      :src="
                        require('~/static/images/products/product-5-245x245.jpg')
                      "
                      alt=""
                    />
                  </a>
	 ...
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z"
                ...
                <div class="product-card__image">
                  <a href="product-full.html">
                    <img
                      :src="
                        require('~/static/images/products/product-6-245x245.jpg')
                      "
                      alt=""
                    />
                  </a>
	 ...
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z"
                ...
                <div class="product-card__image">
                  <a href="product-full.html">
                    <img
                      :src="
                        require('~/static/images/products/product-7-245x245.jpg')
                      "
                      alt=""
                    />
                  </a>
	 ...
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z"
                ...
                <div class="product-card__image">
                  <a href="product-full.html">
                    <img
                      :src="
                        require('~/static/images/products/product-8-245x245.jpg')
                      "
                      alt=""
                    />
                  </a>
	 ...
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z"
                ...
                <div class="product-card__image">
                  <a href="product-full.html">
                    <img
                      :src="
                        require('~/static/images/products/product-9-245x245.jpg')
                      "
                      alt=""
                    />
                  </a>
	 ...
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z"
                ...
                <div class="product-card__image">
                  <a href="product-full.html">
                    <img
                      :src="
                        require('~/static/images/products/product-10-245x245.jpg')
                      "
                      alt=""
                    />
                  </a>
