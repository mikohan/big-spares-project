      ...
      <div class="topbar__menu">
        ...
        <div class="topbar__menu-body">
          <a class="topbar__menu-item" href="#">
            <img
              :src="require('~/static/images/languages/language-1.png')"
              alt=""
            /><span>English</span>
          </a>
          <a class="topbar__menu-item" href="#">
            <img
              :src="require('~/static/images/languages/language-2.png')"
              alt=""
            /><span>French</span>
          </a>
          <a class="topbar__menu-item" href="#">
            <img
              :src="require('~/static/images/languages/language-3.png')"
              alt=""
            /><span>German</span>
          </a>
          <a class="topbar__menu-item" href="#">
            <img
              :src="require('~/static/images/languages/language-4.png')"
              alt=""
            /><span>Russian</span>
          </a>
          <a class="topbar__menu-item" href="#">
            <img
              :src="require('~/static/images/languages/language-5.png')"
              alt=""
            /><span>Italian</span>
          </a>
        </div>
