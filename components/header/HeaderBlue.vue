<template>
  <div>
          ...
          <div class="mobile-header__body">
            ...
            <a class="mobile-header__logo" href="">
              ...
              <svg width="130" height="20">
                <path
                  class="mobile-header__logo-part-one"
	...
	C11,5.7,10.2,4.6,9,4.2z"
                ></path>
                <path
                  class="mobile-header__logo-part-two"
      ...
      <div class="header">
        ...
        <div class="header__topbar-classic">
          <div class="topbar topbar--classic">
            ...
            <div class="topbar__item-text">
              <a class="topbar__link" href="blog-classic-right-sidebar.html"
                >Blog</a
              >
            </div>
...
import DepartmentsBlue from '~/components/header/DepartmentsBlue'
import VehiclePickerModal from '~/components/header/VehiclePickerModal'
import MenuBlue from '~/components/header/MenuBlue'
