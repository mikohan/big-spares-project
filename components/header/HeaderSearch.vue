  ...
  <div class="header__search">
    <div class="search">
      <form action="" class="search__body">
        ...
        <input
          class="search__input"
          :class="headerType === 'spaceship' ? 'search__input-spaceship' : 'search__input-classic'"
          type="text"
          placeholder="Enter Keyword or Part Number"
        />
        <button class="search__button search__button--start"
        :class="headerType === 'spaceship' ? 'search__button--start-spaceship' : 'search__button--start-classic'"
         type="button">
