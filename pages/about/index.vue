    ...
    <div class="about">
      <div class="about__body">
        <div class="about__image">
          <div
            class="about__image-bg"
            style="background-image: url('images/about-1903x1903.jpg');"
          ></div>
        ...
        <div class="about__card">
          ...
          <div class="about__card-text">
            ...
            work we managed to create a unique service for the sale and delivery
            of spare parts around the world.
          </div>
        ...
        <div class="about__indicators">
          <div class="about__indicators-body">
            <div class="about__indicators-item">
              ...
              <div class="about__indicators-item-title">
    ...
    <div class="block block-reviews">
      <div class="container">
        ...
        <div class="block-reviews__subtitle">
          During our work we have accumulated<br />hundreds of positive reviews.
        </div>
          ...
          <div class="owl-carousel">
            <div class="block-reviews__item">
              <div class="block-reviews__item-avatar">
                <img
                  src="images/testimonials/testimonial-1-190x190.jpg"
                  alt=""
                />
              </div>
              <div class="block-reviews__item-content">
                <div class="block-reviews__item-text">
                  This division is not obsolete but has changed. Natural
                  philosophy has split into the various natural sciences,
                  especially astronomy, and cosmology. Moral philosophy has
                  birthed the social sciences, but still includes value theory.
                </div>
            ...
            <div class="block-reviews__item">
              <div class="block-reviews__item-avatar">
                <img
                  src="images/testimonials/testimonial-2-190x190.jpg"
                  alt=""
                />
              </div>
              <div class="block-reviews__item-content">
                <div class="block-reviews__item-text">
                  ...
                  groupings allow philosophers. The groupings also make
                  philosophy easier for students to approach.
                </div>
                <div class="block-reviews__item-meta">
                  <div class="block-reviews__item-rating">
                    <div class="rating">
            ...
            <div class="block-reviews__item">
              <div class="block-reviews__item-avatar">
                <img
                  src="images/testimonials/testimonial-3-190x190.jpg"
                  alt=""
                />
              </div>
              <div class="block-reviews__item-content">
                <div class="block-reviews__item-text">
                  The ideas conceived by a society have profound repercussions
                  on what actions the society performs. Philosophy yields
                  applications such as those in ethics – applied ethics in
                  particular – and political philosophy.
                </div>
                <div class="block-reviews__item-meta">
                  <div class="block-reviews__item-rating">
                    <div class="rating">
