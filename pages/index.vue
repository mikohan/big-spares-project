  ...
  <div class="site__body">
    <div class="block-finder block">
      ...
      <div
        ...
        style="background-image: url('/images/finder-1903x500.jpg');"
      ></div>
                  ...
                  <div class="product-card__info">
                    ...
                    <div class="product-card__name">
                      <div>
                        ...
                        <a href="product-full.html"
                          >Brandix Spark Plug Kit ASR-400</a
                        >
                      </div>
                    </div>
                  ...
                  <div class="product-card__info">
                    ...
                    <div class="product-card__name">
                      <div>
                        ...
                        <a href="product-full.html"
                          >Left Headlight Of Brandix Z54</a
                        >
                      </div>
                    </div>
                    <div class="product-card__rating">
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z"
                  ...
                  <div class="product-card__info">
                    ...
                    <div class="product-card__name">
                      <div>
                        <a href="product-full.html"
                          >Brandix Manual Five Speed Gearbox</a
                        >
                      </div>
                    </div>
                    <div class="product-card__rating">
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z"
                  ...
                  <div class="product-card__info">
                    ...
                    <div class="product-card__name">
                      <div>
                        <a href="product-full.html"
                          >Set of Car Floor Mats Brandix Z4</a
                        >
                      </div>
                    </div>
                    <div class="product-card__rating">
        ...
        <div class="block-sale__header">
          ...
          <div class="block-sale__timer">
            <div class="timer">
              ...
              <div class="timer__dots"></div>
              <div class="timer__part">
                <div class="timer__part-value timer__part-value--minutes">
                  07
                </div>
              ...
              <div class="timer__dots"></div>
              <div class="timer__part">
                <div class="timer__part-value timer__part-value--seconds">
                  54
                </div>
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z"
        ...
        <div class="block-sale__body">
          ...
          <div
            ...
            style="background-image: url('images/sale-1903x640.jpg');"
          ></div>
          <div class="container">
    ...
    <div class="block block-zone">
      <div class="container">
        <div class="block-zone__body">
          <div
            class="block-zone__card category-card category-card--layout--overlay"
          >
            <div class="category-card__body">
              <div class="category-card__overlay-image">
                <img
                  srcset="
                    images/categories/category-overlay-1-mobile.jpg 530w,
                    images/categories/category-overlay-1.jpg        305w
                  "
              ...
              <div
                class="category-card__overlay-image category-card__overlay-image--blur"
              >
                <img
                  srcset="
                    images/categories/category-overlay-1-mobile.jpg 530w,
              ...
              <div class="category-card__content">
                <div class="category-card__info">
                  ...
                  <ul class="category-card__children">
                    <li>
                      <a href="category-4-columns-sidebar.html">Wheel Covers</a>
                    </li>
                    <li>
                      <a href="category-4-columns-sidebar.html">Brake Kits</a>
                    </li>
                    <li>
                      <a href="category-4-columns-sidebar.html">Tire Chains</a>
                    </li>
                    <li>
                      <a href="category-4-columns-sidebar.html">Wheel disks</a>
                    </li>
                    <li><a href="category-4-columns-sidebar.html">Tires</a></li>
                    <li>
                      <a href="category-4-columns-sidebar.html">Sensors</a>
                    </li>
                    <li>
                      <a href="category-4-columns-sidebar.html">Accessories</a>
                    </li>
                  </ul>
          ...
          <div class="block-zone__widget">
            <div class="block-zone__widget-header">
              <div class="block-zone__tabs">
                ...
                <button class="block-zone__tabs-button" type="button">
                  Bestsellers
                </button>
                <button class="block-zone__tabs-button" type="button">
                  Popular
              ...
              <div
                class="arrow block-zone__arrow block-zone__arrow--prev arrow--prev"
              >
                <button class="arrow__button" type="button">
                  <svg width="7" height="11">
                    <path
              ...
              <div
                class="arrow block-zone__arrow block-zone__arrow--next arrow--next"
              >
                <button class="arrow__button" type="button">
                  <svg width="7" height="11">
                    <path
          ...
          >
            <div class="category-card__body">
              <div class="category-card__overlay-image">
                <img
                  srcset="
                    images/categories/category-overlay-2-mobile.jpg 530w,
                    images/categories/category-overlay-2.jpg        305w
                  "
              ...
              <div class="category-card__content">
                <div class="category-card__info">
                  ...
                  <ul class="category-card__children">
                    <li>
                      <a href="category-4-columns-sidebar.html">Dashboards</a>
                    </li>
                    <li>
                      <a href="category-4-columns-sidebar.html">Seat Covers</a>
                    </li>
                    <li>
                      <a href="category-4-columns-sidebar.html">Floor Mats</a>
                    </li>
                    <li>
                      <a href="category-4-columns-sidebar.html">Sun Shades</a>
                    </li>
                    <li>
                      <a href="category-4-columns-sidebar.html">Visors</a>
                    </li>
                    <li>
                      <a href="category-4-columns-sidebar.html">Car Covers</a>
                    </li>
                    <li>
                      <a href="category-4-columns-sidebar.html">Accessories</a>
                    </li>
          ...
          >
            <div class="category-card__body">
              <div class="category-card__overlay-image">
                <img
                  srcset="
                    images/categories/category-overlay-3-mobile.jpg 530w,
                    images/categories/category-overlay-3.jpg        305w
                  "
              ...
              <div class="category-card__content">
                <div class="category-card__info">
                  ...
                  <ul class="category-card__children">
                    <li>
                      <a href="category-4-columns-sidebar.html">Timing Belts</a>
                    </li>
                    <li>
                      <a href="category-4-columns-sidebar.html">Spark Plugs</a>
                    </li>
                    <li>
                      <a href="category-4-columns-sidebar.html">Oil Pans</a>
                    </li>
                    <li>
                      <a href="category-4-columns-sidebar.html"
                        >Engine Gaskets</a
                    ...
                    <li>
                      <a href="category-4-columns-sidebar.html">Oil Filters</a>
                    </li>
                    <li>
                      <a href="category-4-columns-sidebar.html"
                        >Engine Mounts</a
      ...
      <div class="container">
        <div class="block-banners__list">
          ...
          >
            ...
            /></span>
            <span
              class="block-banners__item-image block-banners__item-image--blur"
              ><img src="images/banners/banner1.jpg" alt=""
            /></span>
    ...
    <div class="block-space block-space--layout--divider-nl"></div>
    <div
      class="block block-posts-carousel block-posts-carousel--layout--grid"
      data-layout="grid"
    >
      <div class="container">
        <div class="section-header">
                ...
                <div class="post-card__content">
                  ...
                  <div class="post-card__excerpt">
                    <div class="typography">
                      ...
                      Donec facilisis neque ut purus fermentum, ac pretium nibh
                      facilisis. Vivamus venenatis viverra iaculis. Suspendisse
                      tempor orci non sapien ullamcorper dapibus. Suspendisse at
                      velit diam. Donec pharetra nec enim blandit vulputate.
                    </div>
                  </div>
                  <div class="post-card__more">
                    <a
                      href="post-full-width.html"
              ...
              <div class="post-card">
                ...
                <div class="post-card__content">
                  ...
                  <div class="post-card__title">
                    <h2>
                      <a href="post-full-width.html"
                        >Logic Is The Study Of Reasoning And Argument Part 2</a
                      >
                    </h2>
                  </div>
                  <div class="post-card__date">
              ...
              <div class="post-card">
                ...
                <div class="post-card__content">
                  ...
                  <div class="post-card__title">
                    <h2>
                      <a href="post-full-width.html"
                        >A Variety Of Other Academic And Non-Academic Approaches
                        Have Been Explored</a
                      >
                    </h2>
                  </div>
                  <div class="post-card__date">
              ...
              <div class="post-card">
                ...
                <div class="post-card__content">
                  ...
                  <div class="post-card__title">
                    <h2>
                      <a href="post-full-width.html"
                        >Logic Is The Study Of Reasoning And Argument Part 1</a
                      >
                    </h2>
                  </div>
                  <div class="post-card__date">
    ...
    <div
      class="block-space block-space--layout--divider-nl d-xl-block d-none"
    ></div>
