  ...
  <div>
	...
	c-3.9,0-7,3.1-7,7s3.1,7,7,7s7-3.1,7-7S18.9,2,15,2z M16,13h-2v-3h-3V8h3V5h2v3h3v2h-3V13z"
                      ...
                      <div class="owl-carousel">
                        <a
                          v-for="img in getProduct.product_image"
                          :key="img.img150"
                          :href="img.img800"
                          target="_blank"
                        >
...
import RelatedProducts from '~/components/productBlocks/RelatedProducts'
import ProductTabs from '~/components/productBlocks/ProductTabs'
export default {
  components: {
    RelatedProducts,
    ProductTabs
