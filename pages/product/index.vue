<template>
  ...
  <div class="site__body">
	...
	c-3.9,0-7,3.1-7,7s3.1,7,7,7s7-3.1,7-7S18.9,2,15,2z M16,13h-2v-3h-3V8h3V5h2v3h3v2h-3V13z"
                ...
                <div class="product__header">
                  <h1 class="product__title">
                    Brandix Brake Kit BDX-750Z370-S
                  </h1>
                ...
                <div class="product__main">
                  <div class="product__excerpt">
                    ...
                    associated with wisdom, intellectual culture and a search
                    for knowledge.
                  </div>
	...
	s0.4-0.1,0.5-0.2l1.8-1.8l5.3,5.3c0.2,0.2,0.4,0.2,0.5,0.2c0.2,0,0.4-0.1,0.5-0.2c0.3-0.3,0.3-0.8,0-1.1L27.4,15.8z"
                ...
                <div
                  class="product__tabs product-tabs product-tabs--layout--full"
                >
                    ...
                    >
                      <div class="typography">
                        <p>
                          ...
                          elit. Maecenas fermentum, diam non iaculis finibus,
                          ipsum arcu sollicitudin dolor, ut cursus sapien sem
                          sed purus. Donec vitae fringilla tortor, sed fermentum
                          nunc. Suspendisse sodales turpis dolor, at rutrum
                          dolor tristique id. Quisque pellentesque ullamcorper
                          felis, eget gravida mi elementum a. Maecenas
                          consectetur volutpat ante, sit amet molestie urna
                          luctus in. Nulla eget dolor semper urna malesuada
                          dictum. Duis eleifend pellentesque dui et finibus.
                          Pellentesque dapibus dignissim augue. Etiam odio est,
                          sodales ac aliquam id, iaculis eget lacus. Aenean
                          porta, ante vitae suscipit pulvinar, purus dui
                          interdum tellus, sed dapibus mi mauris vitae tellus.
                        </p>
                        <h4>Etiam lacus lacus mollis in mattis</h4>
                        <p>
                          Praesent mattis eget augue ac elementum. Maecenas vel
                          ante ut enim mollis accumsan. Vestibulum vel eros at
                          mi suscipit feugiat. Sed tortor purus, vulputate et
                          eros a, rhoncus laoreet orci. Proin sapien neque,
                          commodo at porta in, vehicula eu elit. Vestibulum ante
                          ipsum primis in faucibus orci luctus et ultrices
                          posuere cubilia Curae; Curabitur porta vulputate
                          augue, at sollicitudin nisl molestie eget.
                        </p>
                        <p>
                          Nunc sollicitudin, nunc id accumsan semper, libero
                          nunc aliquet nulla, nec pretium ipsum risus ac neque.
                          Morbi eu facilisis purus. Quisque mi tortor, cursus in
                          nulla ut, laoreet commodo quam. Pellentesque et ornare
                          sapien. In ac est tempus urna tincidunt finibus.
                          Integer erat ipsum, tristique ac lobortis sit amet,
                          dapibus sit amet purus. Nam sed lorem nisi. Vestibulum
                          ultrices tincidunt turpis, sit amet fringilla odio
                          scelerisque non.
                        </p>
                      </div>
                    </div>
                                ...
                                <div class="review">
                                  <div class="review__body">
                                    ...
                                    <div class="review__content typography">
                                      Phasellus id mattis nulla. Mauris velit
                                      nisi, imperdiet vitae sodales in, maximus
                                      ut lectus. Vivamus commodo scelerisque
                                ...
                                <div class="review">
                                  <div class="review__body">
                                    ...
                                    <div class="review__content typography">
                                      ...
                                      augue. Donec tempor sapien et fringilla
                                ...
                                <div class="review">
                                  <div class="review__body">
                                    ...
                                    <div class="review__content typography">
                                      ...
                                      egestas. Pellentesque hendrerit eros
                                      laoreet suscipit ultrices.
                                    </div>
                                  </div>
                                </div>
                              </li>
                      ...
                      <table class="analogs-table">
                        <thead>
                          <tr>
                            ...
                            <th
                              class="analogs-table__column analogs-table__column--rating"
                            >
                              Rating
                            </th>
                            <th
                              class="analogs-table__column analogs-table__column--vendor"
                            >
                              Vendor
                            </th>
                            <th
                              class="analogs-table__column analogs-table__column--price"
                            >
                              Price
                            </th>
                          </tr>
                        ...
                        <tbody>
                          <tr>
                            <td
                              class="analogs-table__column analogs-table__column--name"
                            >
                              <a href="" class="analogs-table__product-name"
                                >Sunset Brake Kit</a
                              ><br />
                            ...
                            >
                              Sunset
                              <div class="analogs-table__country">
                                (Germany)
                              </div>
                            </td>
                            <td
  ...
  mounted() {
        ...
        $('.product-tabs').each(function(i, element) {
          $('.product-tabs__list', element).on(
            ...
            function(event) {
              ...
              if (content.length) {
                $('.product-tabs__item').removeClass(
                  'product-tabs__item--active'
                )
                tab.addClass('product-tabs__item--active')

                $('.product-tabs__pane').removeClass(
    ...
    */
      $(function() {
        ...
        $('.payment-methods__item-container').on('transitionend', function(
          event
        ) {
          if (event.originalEvent.propertyName === 'height') {
            $(this).css('height', '')
    ...
    */
      $(function() {
        ...
        $('.vehicle-picker [data-to-panel]').on('click', function(event) {
          ...
          const toPanel = $(this).data('to-panel')
          const currentPanel = vehiclePicker.find(
