              ...
              <div class="category-card__content">
                ...
                <div class="category-card__info">
                  ...
                  <ul class="category-card__children">
                    <li v-for="sub in cat.children.slice(0,10)" :key="sub.id"><a href="">{{ sub.name }}</a></li>
                  </ul>
            ...
            <div class="block">
              ...
              >
                <ul class="categories-list__body">
                  ...
                  <!-- <li v-for="divider in getCategories" :key="divider.id" class="categories-list__divider"></li> -->
                  <!-- <li class="categories-list__item">
                    <a href="">
                      <img
                        src="/images/categories/category-2-200x200.jpg"
                        alt=""
                      />
                      <div class="categories-list__item-name">
                        Fuel System & Filters
                  ...
                  <li class="categories-list__item">
                    <a href="">
                      <img
                        src="/images/categories/category-3-200x200.jpg"
                        alt=""
                      />
                      <div class="categories-list__item-name">
                        Body Parts & Mirrors
                  ...
                  <li class="categories-list__item">
                    <a href="">
                      <img
                        src="/images/categories/category-4-200x200.jpg"
                        alt=""
                      />
                      <div class="categories-list__item-name">
                  ...
                  <li class="categories-list__item">
                    <a href="">
                      <img
                        src="/images/categories/category-5-200x200.jpg"
                        alt=""
                      />
                      <div class="categories-list__item-name">
                        Tires & Wheels
                  ...
                  <li class="categories-list__item">
                    <a href="">
                      <img
                        src="/images/categories/category-6-200x200.jpg"
                        alt=""
                      />
                      <div class="categories-list__item-name">
                        Engine & Drivetrain
                  ...
                  <li class="categories-list__item">
                    <a href="">
                      <img
                        src="/images/categories/category-7-200x200.jpg"
                        alt=""
                      />
                      <div class="categories-list__item-name">
                        Oils & Lubricants
                  ...
                  <li class="categories-list__item">
                    <a href="">
                      <img
                        src="/images/categories/category-8-200x200.jpg"
                        alt=""
                      />
                      <div class="categories-list__item-name">
                        Tools & Garage
                ...
                <div class="block-products-carousel__carousel">
                  ...
                  <div class="owl-carousel">
                    <div class="block-products-carousel__column">
                      <div class="block-products-carousel__cell">
                        <div
                          class="product-card product-card--layout--horizontal"
                        >
                          <div class="product-card__actions-list">
                            <button
                              class="product-card__action product-card__action--quickview"
